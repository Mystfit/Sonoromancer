...
void FluidPlayer::loadInstruments()
{
    ...
    for(int i=0; i < instrumentFiles.size(); i++)
    {
        ...
        instrumentList.push_back(readInstrumentXML(xmlInstrument));
    }
}
...
FluidInstrument FluidPlayer::readInstrumentXML(ofxXmlSettings xmlInstrument){
...
void FluidPlayer::saveInstruments(){
    for(int i = 0; i < instrumentList.size(); i++){
        writeInstrumentXML(instrumentList[i]);
    }
}



void FluidPlayer::writeInstrumentXML(FluidInstrument instrument){
